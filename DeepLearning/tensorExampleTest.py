...
testX, testY = load_csv('test.csv', has_header=True, target_column=0, categorical_labels=True, n_classes=4)
...
model.fit(data, labels, n_epoch=40, batch_size=1, show_metric=True)

# Testing model
student1 = [5.0, 5.0, 5.0]
student2 = [0.0, 0.0, 0.0]
student3 = [5.0, 4.0, 3.0]
